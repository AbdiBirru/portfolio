...
export function BlueskyIcon({ size = 20, className }: IconProps) {
  return (
    <svg role="img" viewBox="0 0 24 24" width={size} height={size} fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 10.8c-1.087-2.114-4.046-6.053-6.798-7.995C2.566.944 1.561 1.266.902 1.565.139 1.912 0 3.083 0 3.767c0 .684.378 5.604.624 6.412.815 2.672 3.712 3.58 6.383 3.271 3.912-.58 3.912.99-.83 1.844C2.164 15.874-1.311 17.865 3.246 22.938c5.013 5.19 6.87-1.113 7.823-4.308.953 3.195 2.05 9.271 7.733 4.308 4.267-4.308 1.172-6.498-2.74-7.078-4.742-.854-4.742-2.424-.83-1.844 2.67.309 5.568-.599 6.383-3.27.246-.809.624-5.729.624-6.413 0-.684-.139-1.855-.902-2.202-.659-.299-1.664-.62-4.3 1.24C16.046 4.748 13.087 8.687 12 10.8Z" />
    </svg>
  );
}
